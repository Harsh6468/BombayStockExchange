...
public class StockExchange {
    ...
    StockExchange(boolean darkTheme)
    {
        ...
        jFrame.setIconImage(new ImageIcon("C:\\Users\\Harsh\\IdeaProjects\\File_Handling\\src\\StEx.png").getImage());
        ...
        titleBarIcon.setBounds(2,2,30,25);
        BufferedImage img = null;
        try {
            img = ImageIO.read(new File("C:\\Users\\Harsh\\IdeaProjects\\File_Handling\\src\\StEx.png"));
